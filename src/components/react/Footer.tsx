  ...
  return (
    <footer className="border-t border-white/5 py-5" role="contentinfo">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-6 sm:flex-row sm:gap-4">
        <a
          href="/"
          className="font-display text-sm font-semibold text-zinc-400 transition hover:text-accent"
          aria-label="Lucas Ruiz - Inicio"
        >
          Lucas Ruiz
        </a>
        <p className="order-last text-xs text-zinc-500 sm:order-none">
          © {year} · {trl.madeWith}
        </p>
